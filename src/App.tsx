        ...
        <div className="" data-aos="fade-left">
          <div className="grid grid-cols-3 gap-4">
            <div className='col-span-2'>
              <h1 className="text-[#fff] xl:text-5xl lg:text-4xl md:text-4xl sm:text-4xl  text-3xl font-bold ">I'm Ayoria<br /> <span className='animated-gradient-text'>Web Developer</span> </h1>
            </div>
